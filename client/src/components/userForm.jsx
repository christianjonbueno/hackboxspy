        ...
        <div className="col-md-auto form-group">
          <form id="form" onSubmit={(e) => props.enterRoom(e)} >
            ...
            <select name="room" onChange={(e) => props.onInputChange(e)} defaultValue="einstein">
              {props.allRooms.einstein < 4 ? <option value="einstein">Einstein</option>: <option value="einstein" disabled>Einstein (full)</option>}
              {props.allRooms.sunshine < 4 ? <option value="sunshine">Sunshine</option>: <option value="sunshine" disabled>Sunshine (full)</option>}
              {props.allRooms.outcomes < 4 ? <option value="outcomes">Outcomes</option>: <option value="outcomes" disabled>Outcomes (full)</option>}
              {props.allRooms.pingpong < 4 ? <option value="pingpong">Pingpong</option>: <option value="pingpong" disabled>Pingpong (full)</option>}
            </select>
            <p/>
