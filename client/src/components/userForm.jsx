        ...
        <div className="col-md-auto form-group">
          <form id="form" onSubmit={(e) => props.enterRoom(e)} >
            ...
            <select name="room" onChange={(e) => props.onInputChange(e)} defaultValue="einstein">
              ...
              {props.allRoomsCount['einstein'] < 4 ? <option value="einstein">Einstein</option>: null }
              ...
              {props.allRoomsCount['sunshine'] < 4 ? <option value="sunshine">Sunshine</option>: null }
              ...
              {props.allRoomsCount['outcomes'] < 4 ? <option value="outcomes">Outcomes</option>: null }
              ...
              {props.allRoomsCount['pingpong'] < 4 ? <option value="pingpong">Pingpong</option>: null }
